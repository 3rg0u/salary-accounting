...
@section('content')
    ...
    <div class="header">
        <p style="text-align: center" class="h1 alert alert-info">Thêm Khoa Mới</p>
    </div>

    <div class="body">
        <div class="navigation d-flex justify-content-start">
            <button class="btn btn-secondary btn-lg d-flex align-items-center gap-1"
                onclick="window.location.href='{{ route('admin.falculty.index') }}'">
        ...
        <div class=" content-display">
            <div class="container-fluid">
                <div class="show-form m-auto d-flex align-items-center w-25 py-5">
                    <form action="{{route('admin.falculty.create')}}" method="post" class="w-100">
                        @csrf
                        <div class="mb-3">
