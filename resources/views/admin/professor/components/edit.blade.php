<div class="modal fade" id="_editInfor_{{$professor->pid}}" tabindex="-1" aria-labelledby="editInfor"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.professor.edit', ['id' => $professor->pid])}}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="mb-3">
